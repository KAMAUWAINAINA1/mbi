...
const I18N = {
  ...
  "team.1.role":{fr:"Fondateur et directeur, Stratégie et développement durable et inclusif",en:"Founder and Director, Strategy and Sustainable and Inclusive Development",es:"Fundador y director, Estrategia y desarrollo sostenible e inclusivo",sw:"Mwanzilishi na Mkurugenzi, Mkakati na Maendeleo Endelevu na Jumuishi",zh:"创始人兼总监，战略与可持续包容发展"},
  ...
  "team.3.role":{fr:"Stratégie, développement commercial & optimisation · 25+ ans",en:"Strategy, business development & optimisation · 25+ yrs",es:"Estrategia, desarrollo de negocio y optimización · más de 25 años",sw:"Mkakati, ukuzaji wa biashara na uboreshaji · zaidi ya miaka 25",zh:"战略、业务发展与优化 · 25+ 年"},
  "team.3.bio":{fr:"Titulaire d'une maîtrise en gestion-comptabilité de l'ENA de Bamako, il cumule plus de 25 ans d'expérience en finance et administration, dont plus de 17 ans dans le secteur minier. Après huit ans en cabinet d'expertise comptable (EGCC International, correspondant de KPMG au Mali), il a occupé des postes de direction financière chez AngloGold Ashanti (contrôleur financier de Morila, puis Senior Finance Manager et administrateur en Guinée), Randgold/Barrick (Senior Financial Manager des mines de Loulo et Gounkoto) et au MCA-Mali (DAF d'un fonds public de 460 M USD). En 2021, il fonde Leading Partners, cabinet de conseil accompagnant entreprises et États dans l'optimisation des coûts, la gouvernance et un partage plus équilibré de la rente minière. Il a participé à l'audit du secteur aurifère malien ainsi qu'à la rédaction du nouveau Code minier, de la loi sur le contenu local et des décrets sur les fonds miniers.",
                en:"Holds a Master's in Management & Accounting from ENA Bamako and brings over 25 years' experience in finance and administration, including more than 17 years in mining. After eight years in public accountancy (EGCC International, KPMG's correspondent firm in Mali), he held senior finance roles at AngloGold Ashanti (Financial Controller at Morila, then Senior Finance Manager and board member in Guinea), Randgold/Barrick (Senior Financial Manager for the Loulo and Gounkoto mines) and MCA-Mali (Administrative & Finance Director of a US$460m public fund). In 2021 he founded Leading Partners, an advisory firm helping companies and governments with cost optimisation, governance and a fairer sharing of mineral rent. He took part in the audit of Mali's gold sector and in drafting the new Mining Code, the Local Content law and the mining-fund decrees.",
                es:"Máster en Gestión y Contabilidad por la ENA de Bamako, con más de 25 años de experiencia en finanzas y administración, de los cuales más de 17 en el sector minero. Tras ocho años en una firma de auditoría (EGCC International, corresponsal de KPMG en Malí), ocupó cargos de dirección financiera en AngloGold Ashanti (controlador financiero de Morila y luego Senior Finance Manager y miembro del consejo en Guinea), Randgold/Barrick (Senior Financial Manager de las minas de Loulo y Gounkoto) y MCA-Malí (director administrativo y financiero de un fondo público de 460 millones de USD). En 2021 fundó Leading Partners, firma de consultoría que acompaña a empresas y Estados en la optimización de costes, la gobernanza y un reparto más equilibrado de la renta minera. Participó en la auditoría del sector aurífero maliense y en la redacción del nuevo Código Minero, la ley de contenido local y los decretos sobre los fondos mineros.",
                sw:"Ana shahada ya uzamili katika Usimamizi na Uhasibu kutoka ENA Bamako, akiwa na uzoefu wa zaidi ya miaka 25 katika fedha na utawala, ikiwemo zaidi ya miaka 17 katika sekta ya uchimbaji madini. Baada ya miaka minane katika kampuni ya uhasibu (EGCC International, mwakilishi wa KPMG nchini Mali), alishika nyadhifa za juu za fedha katika AngloGold Ashanti (Mdhibiti wa Fedha wa Morila, kisha Senior Finance Manager na mjumbe wa bodi nchini Guinea), Randgold/Barrick (Senior Financial Manager wa migodi ya Loulo na Gounkoto) na MCA-Mali (Mkurugenzi wa Utawala na Fedha wa mfuko wa umma wa dola milioni 460). Mwaka 2021 alianzisha Leading Partners, kampuni ya ushauri inayosaidia makampuni na serikali katika uboreshaji wa gharama, utawala bora na mgawanyo wa haki zaidi wa mapato ya madini. Alishiriki katika ukaguzi wa sekta ya dhahabu ya Mali na katika kuandaa Kanuni mpya ya Madini, sheria ya Maudhui ya Ndani na amri za mifuko ya madini.",
                zh:"持有巴马科国家行政学院(ENA)管理与会计硕士学位,拥有25年以上财务与行政经验,其中逾17年在矿业领域。在会计师事务所(EGCC International,毕马威在马里的成员所)工作八年后,他先后在AngloGold Ashanti(Morila财务总监,后任几内亚Senior Finance Manager及董事会成员)、Randgold/Barrick(Loulo与Gounkoto金矿Senior Financial Manager)及MCA-Mali(4.6亿美元公共基金的行政与财务总监)担任高级财务职务。2021年,他创立咨询公司Leading Partners,协助企业与政府开展成本优化、治理及更公平的矿业收益分配。他参与了马里黄金行业审计,以及新《矿业法》、本地化内容法和矿业基金相关法令的起草工作。"},

  "team.4.role":{fr:"Conseil minier & ESG · 35+ ans",en:"Mining & ESG consultant · 35+ yrs",es:"Consultoría minera y ESG · más de 35 años",sw:"Ushauri wa uchimbaji madini na ESG · zaidi ya miaka 35",zh:"矿业与 ESG 顾问 · 35+ 年"},
  "team.4.bio":{fr:"Ingénieur des mines et dirigeant fort de plus de 35 ans d'expérience internationale multi-produits en exploitation, développement de projets, relations avec les gouvernements et les peuples autochtones et en ESG, principalement chez Anglo American et De Beers, au Canada, en Amérique du Sud, en Afrique australe et de l'Ouest, en Russie et au Royaume-Uni. Avant son départ à la retraite de De Beers en 2016, il était directeur des opérations (COO) de De Beers Canada, responsable de l'excellence opérationnelle et de la sécurité des mines de diamants de Snap Lake et Victor. Il a notamment piloté l'obtention des permis, la concertation avec les communautés autochtones et la gestion de projet de la mine de diamants Gahcho Kué (Territoires du Nord-Ouest), livrée dans les délais et le budget en 2016. Aujourd'hui consultant indépendant, il a siégé aux conseils d'administration de sociétés cotées, dont Fortune Minerals et Atrum Coal, où il est administrateur depuis 2020 et président depuis 2021.",
